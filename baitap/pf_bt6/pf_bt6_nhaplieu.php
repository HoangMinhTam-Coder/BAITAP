        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h4>BÀI 6: Thiết kế Form Kết quả thi đại học</h4>
                    ...
                    <form action="pf_bt6_ketqua.php" method="POST">
                        <table align="center">
                            <tr>
                            ...
                            <?php if (isset($error2)) echo "<tr><td><td><b style='color: red;'>$error2</b></td></td></tr>" ?>
